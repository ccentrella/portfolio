        ...
        <section>
            ...
            <div>
                ...
                <div>
                    ...
                    <p className="resume-item-subheading">
                        St. Paul Center - Internship, Steubenville (OH)
                        <br />
                        Jan 2022 — May 2022
                    </p>
                    <p>Worked in a team of 5 members and reported to the Product Owner</p>
                    <p>Worked on improving the website usability:</p>
                    <ul>
                    ...
                    <p>Followed Agile workflow with regular meetings, demos, bug reviews, and version control:</p>
                    <ul>
                        <li>Participated in weekly meetings with the Product Owner</li>
                        <li>Participated in retrospectives and sprint planning sessions</li>
                    </ul>
                ...
                <div>
                    ...
                    <p>Led teams of 2-4 people and managed the end-to-end creation of 5 client websites</p>
                    <p>Interacted with clients, and worked to implement processes for the startup:</p>
                    <ul>
                        <li>Performed SQL database tasks, interacted with Linux server console, configured web domains, used cPanel and login, and managed virtual machines using SSH</li>
                    </ul>
