...
function UXEngineeringSectionBlock({ src, alt, color }) {
    return (
        <div className="section-block transparent">
            ...
            <div className="section-block-content backdrop flex-col">
                <h2 className="button-label">UX Engineering</h2>
                <p>One of my favorite specialties in software engineering is UX engineering, also known as User Experience Design. Creating user interfaces has always fascinated me, and I’ve always wanted to build rich, modern user interfaces. Since I began programming, I’ve written over 10+ apps, most of them using Windows Presentation Foundation or WPF, which is known for its ability to create rich, user-oriented interfaces, with more flexibility than CSS.</p>
...
export default UXEngineeringSectionBlock;
