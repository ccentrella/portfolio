    ...
    return (
        <section>
            ...
            <div className="container">
                ...
                <p>Software: MS Office, iWork, Adobe CC, WordPress, D2L, Cucumber, Virtual Box, Hyper-V, WSL2</p>
                <p>Programming Languages: Python, C#, Ruby, HTML/CSS/SCSS, XAML, Java, JavaScript</p>
                <p>Database Technologies: MySQL, PostgreSQL</p>
                ...
                <p>Open-source Platforms/Frameworks: .NET, WPF, Xamarin, Ruby on Rails, Spring Boot</p>
